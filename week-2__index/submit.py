...
key = "viRfERcFEeiXChID7wPIVg" # Assessment key found on the authoring side (top of page)
all_parts = ["EviRI"] # Part IDs found on the authoring side

email =  input("What is your Coursera email?\n")
secret = input("What is your Coursera token? (please find this on the assessment page)\n")

part = "EviRI"
assignment_files = [ 'index/wrapper.py', 'search_shell/qtree.py' ]
