...
key = "vSFbyRcHEeiXChID7wPIVg" # Assessment key found on the authoring side (top of page)
all_parts = ["9o3SG"] # Part IDs found on the authoring side

email =  input("What is your Coursera email?\n")
secret = input("What is your Coursera token? (please find this on the assessment page)\n")

part = "9o3SG"
assignment_files = [ 'spellchecker/dictionary.py', 'spellchecker/spellchecker.py' ]
