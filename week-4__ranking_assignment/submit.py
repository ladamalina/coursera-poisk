...
key = "bZR27hcNEeiPqRKmrDDkig" # Assessment key found on the authoring side (top of page)
all_parts = ["iZsed"] # Part IDs found on the authoring side

email =  input("What is your Coursera email?\n")
secret = input("What is your Coursera token? (please find this on the assessment page)\n")

part = "R5GJE"
assignment_files = [ 'search_shell/qtree.py' ]
